...
describe('JsonLdSerializer', () => {
  ...
  it('should serialize a complex mix of triples and quads', async() => {
    const quads = [
      DF.quad(DF.namedNode('http://data.wikipedia.org/snaks/Assertions'), DF.namedNode('http://www.w3.org/1999/02/22-rdf-syntax-ns#type'), DF.namedNode('http://data.wikipedia.org/vocab#SnakSet')),
      DF.quad(DF.namedNode('http://data.wikipedia.org/snaks/Assertions'), DF.namedNode('http://data.wikipedia.org/vocab#assertedBy'), DF.literal('http://gregkellogg.net/foaf#me')),
      DF.quad(DF.namedNode('http://data.wikipedia.org/snaks/BerlinFact'), DF.namedNode('http://www.w3.org/1999/02/22-rdf-syntax-ns#type'), DF.namedNode('http://data.wikipedia.org/vocab#Snak'), DF.namedNode('http://data.wikipedia.org/snaks/Assertions')),
